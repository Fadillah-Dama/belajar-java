...
public class No1 {
    public static void main(String[] args) {
        ...
        System.out.println("Anda berangkat pada : " + tanggalBerangkat + " - " +  bulanBerangkat + " - " + tahunBerangkat);
        ...
        int bulanTambahan = (tanggalBerangkat + tanggalPulang-1)/30;
        int tahunPulang = jumlahHariPulang/360;
        int bulanPulang = ((jumlahHariPulang-1)%360+1)/30 + bulanTambahan ;
